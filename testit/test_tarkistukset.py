...
def test_tekstiositus_ja_yhteensa_paattely():
    ...
    srk = Muuttuja(
        ...
        ["S", "EI", "EVL", "ORT", "SAK", "OP", "a", "b", "c"],
        ["Yhteensä", "Ei-kirkollisverovelvolliset yhteensä", "Evankelis-luterilaiset seurakunnat yhteensä",
         "Ortodoksiset seurakunnat yhteensä", "Suomen saksalainen evankelis-luterilainen seurakunta",
         "Olaus Petrin seurakunta", "Alajärven seurakunta", "Helsingin ortodoksinen seurakunta",
    ...
    # Yhteensä-rivi sisältää pääryhmien lisäksi kaksi erikseen listattua seurakuntaa;
    # rakennetta ei ole dokumentoitu, joten pääjako on varmistamaton
    assert o["paajako"] == (["EI", "EVL", "ORT", "SAK", "OP"], True), o
    assert o["seurakunnat"] == (["EI", "SAK", "OP", "a", "b", "c"], True), o
